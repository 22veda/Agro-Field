          ...
          <div class="box">
			...
			while($row = $result->fetch_assoc()) { ?>
			  ...
			  <div class="product-thumb transition">
                  <div class="image product-imageblock"> <a href='product1.php?id=<?php echo $row["productID"];?>'><img src="<?php echo $row["imgLocation"]?>" alt="lorem ippsum dolor dummy" title="lorem ippsum dolor dummy" class="img-responsive" /> </a>
                  </div>
