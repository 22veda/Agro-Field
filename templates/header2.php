  ...
  <div class="nav-inner container">
    ...
    <div class="navbar-collapse">
      <ul class="main-navigation">
        <li><a href="traderlogin.php"   class="parent"  >Home</a> </li>
        <li><a href="mybids.php"   class="parent">My bids</a> </li>
        <li><a href="mybidhistory.php"   class="parent">My bid history</a></li>
        <li><a href="alloffersfarmer.php"   class="parent"  >All products</a> </li>
