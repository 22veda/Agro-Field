            ...
            <div id="top-links" class="nav pull-right">
			  ...
			  <li class="dropdown"><a href="#" title="My Account" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-user"></i><span><?php echo $_SESSION["userid"] ?></span> <span class="caret"></span></a>
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="base.php">My products</a></li>
					<li><a href="alloffersfarmer.php">All products</a></li>
					<li><a href="createoffer.php">Upload new product</a></li>
  ...
  <div class="nav-inner container">
    ...
    <div class="navbar-collapse">
      <ul class="main-navigation">
        <li><a href="farmerlogin.php"   class="parent"  >Home</a> </li>
        <li><a href="base.php"   class="parent" >My products</a>
		<ul>
            <li><a href="current.php">Current crops</a></li>
            <li><a href="history.php">History</a></li>
          </ul></li>
		<li><a href="alloffersfarmer.php">All products</a></li>
		<li><a href="createnewoffer.php">Upload new product</a></li>
